...
const companyIntroContent = {
  eyebrow: "O nás",
  title: "Profesionální instalatérské a topenářské služby",
  description:
    "V ELVEUL chápeme, jak důležité je mít bezproblémově fungující rozvody vody, odpadů a topení. Proto se zaměřujeme na poskytování prvotřídních instalatérských a topenářských prací, na které se můžete plně spolehnout. Máme přes 30 let zkušeností v oboru od roku 1993.",
  cta: "Více o nás",
          ...
          <article className="flex max-w-[560px] flex-col items-start gap-6">
            <header className="flex flex-col items-start gap-4">
              <div className="inline-flex items-center gap-2.5">
                ...
                />
                <p className="w-fit font-sub-1 text-[length:var(--sub-1-font-size)] font-[number:var(--sub-1-font-weight)] leading-[var(--sub-1-line-height)] tracking-[var(--sub-1-letter-spacing)] text-sky-600 [font-style:var(--sub-1-font-style)]">
            ...
            <Button
              type="button"
              className="h-auto rounded-lg bg-sky-600 px-[50px] py-[18px] font-button text-[length:var(--button-font-size)] font-[number:var(--button-font-weight)] leading-[var(--button-line-height)] tracking-[var(--button-letter-spacing)] text-white hover:bg-sky-500 [font-style:var(--button-font-style)]"
            >
