...
const formFields = [
  { type: "text", placeholder: "Your name", textColor: "text-grey-1" },
  { type: "email", placeholder: "Email", textColor: "text-grey-1" },
  { type: "tel", placeholder: "Phone number", textColor: "text-grey-2" },
  { type: "text", placeholder: "Choose a services", textColor: "text-grey-1" },
];
        ...
        <div className="flex flex-col">
          <header className="max-w-[500px]">
            <p className="mb-4 text-dark-blue [font-family:'Manrope',Helvetica] text-[40px] leading-[44px] tracking-[0] sm:text-[52px] sm:leading-[56px] lg:text-[64px] lg:leading-[64px]">
              ...
              <span className="font-h1 font-[number:var(--h1-font-weight)] text-green tracking-[var(--h1-letter-spacing)] [font-style:var(--h1-font-style)]">
                Reliable
              </span>
              <span className="font-h1 font-[number:var(--h1-font-weight)] tracking-[var(--h1-letter-spacing)] [font-style:var(--h1-font-style)]">
                {" "}
            ...
            <p className="max-w-[448px] font-paragraph-1 text-[length:var(--paragraph-1-font-size)] font-[number:var(--paragraph-1-font-weight)] leading-[var(--paragraph-1-line-height)] tracking-[var(--paragraph-1-letter-spacing)] text-grey-1 [font-style:var(--paragraph-1-font-style)]">
              Pipowork offers reliable plumbing services that cater to all your
              plumbing needs. From simple pipe repairs to complex installations.
            </p>
          </header>
          <div className="mt-12 flex flex-col gap-6 lg:mt-[116px]">
            <section className="flex items-start justify-between gap-6">
              <div className="flex min-w-0 flex-1 flex-col">
                ...
                <Card className="mt-[-3px] w-fit rounded-xl border-0 bg-green-light shadow-none">
                ...
                <Button
                  type="button"
                  variant="ghost"
                  className="mt-6 h-auto w-fit p-0 font-button text-[length:var(--button-font-size)] font-[number:var(--button-font-weight)] leading-[var(--button-line-height)] tracking-[var(--button-letter-spacing)] text-yellow-hover hover:bg-transparent hover:text-yellow-hover"
                >
          ...
          <div className="relative w-full max-w-[509px]">
            <div className="mx-auto flex w-full max-w-[509px] items-start justify-center lg:justify-start">
              <div className="relative h-[360px] w-full max-w-[447px] sm:h-[480px] lg:h-[812px]">
                <div className="absolute left-[14.7651%] top-0 h-full w-[76.0313%] bg-[linear-gradient(180deg,rgba(91,181,67,0)_0%,rgba(91,181,67,1)_100%)]" />
                ...
                <CardContent className="p-9">
                  <div className="flex flex-col items-start gap-6">
                    ...
                    <form className="flex w-full flex-col gap-3">
                      ...
                      <Button
                        type="submit"
                        className="mt-3 h-auto w-fit rounded-lg bg-yellow px-[50px] py-[18px] font-button text-[length:var(--button-font-size)] font-[number:var(--button-font-weight)] leading-[var(--button-line-height)] tracking-[var(--button-letter-spacing)] text-dark-yellow hover:bg-yellow"
                      >
                        Request Services
                      </Button>
                    </form>
            ...
            <aside className="mx-auto mt-8 flex w-fit flex-col items-start gap-2.5 lg:absolute lg:right-0 lg:top-7 lg:mt-0 lg:translate-x-[27px]">
              <button
                type="button"
                className="flex h-[60px] w-[60px] items-center justify-center overflow-hidden rounded-[40px] bg-green"
              >
              ...
              <p className="w-[105px] font-form-field text-[length:var(--form-field-font-size)] font-[number:var(--form-field-font-weight)] leading-[var(--form-field-line-height)] tracking-[var(--form-field-letter-spacing)] text-dark-blue [font-style:var(--form-field-font-style)]">
                See how our team works for you
              </p>
            </aside>
          </div>
        </div>
